...
class ConfigHttp:
    ...
    def put(self):
        ...
        """
        try:
            response = requests.put(self.url, headers=self.headers, data=self.data, params=self.params, timeout=float(timeout))
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
    ...
    def delete(self):
        ...
        """
        try:
            response = requests.delete(self.url, headers=self.headers, data=self.data, params=self.params, timeout=float(timeout))
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
